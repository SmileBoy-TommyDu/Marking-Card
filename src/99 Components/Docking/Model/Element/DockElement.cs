...
namespace DrSoft.Docking.Model.Element
{
    public class DockElement : DependencyObject, IDockElement, IComparable<DockElement>
    {
        ...
        public static readonly DependencyProperty ShowTitleProperty =
            DependencyProperty.Register("ShowTitle", typeof(bool), typeof(DockElement),
        ...
        #region ShowHeaderButtons
        public static readonly DependencyProperty ShowHeaderButtonsProperty =
            DependencyProperty.Register("ShowHeaderButtons", typeof(bool), typeof(DockElement),
                new FrameworkPropertyMetadata(true));
        ...
        public bool ShowHeaderButtons
        {
            ...
            get { return (bool)GetValue(ShowHeaderButtonsProperty); }
        }
        #endregion

        #region ShowTab
        public static readonly DependencyProperty ShowTabProperty =
            DependencyProperty.Register("ShowTab", typeof(bool), typeof(DockElement),
                new FrameworkPropertyMetadata(true));

        /// <summary>
        /// 是否显示选项卡 Tab（仅 Document 模式生效）
        /// </summary>
        public bool ShowTab
        {
