...
namespace DrSoft.Docking.Interface
{
    public interface IDockManager : IDockView
    {
        ...
        void HideAll();
        void UpdateTitleAll();
        void RegisterDocument(IDockSource content, int? id = null, bool canSelect = false, double desiredWidth = Constants.DockDefaultWidthLength, double desiredHeight = Constants.DockDefaultHeightLength, double floatLeft = 0.0, double floatTop = 0.0, bool showTab = true);
