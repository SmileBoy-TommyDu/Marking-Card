...
{
    public interface IMarkController: IDisposable
    {
        ...
        MarkErrorCode LoadFile(uint cardNo, string fileName);
        ...
        /// <returns>返回加载结果</returns>
        MarkErrorCode LoadMarkData(uint cardNo, MarkingJobDto markData);
